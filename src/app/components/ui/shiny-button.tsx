...
const ShinyButton = ({ children, className, ...props }: ShinyButtonProps) => {
  return (
    ...
    >
      <span
        className="relative text-xs md:text-sm underline underline-offset-2 size-full tracking-wide text-[rgb(255,255,255,95%)] font-light flex items-center justify-center gap-2"
        style={{
          maskImage:
